...
// 2_1. active라는 가상클래스가 실행 (*텍스트가 검정색 & 두꺼워짐)

// 2_2. 하단에 lnb요소의 opacity value 값이 1이 되어야 한다.

// 3. mouseleave 또는 mouseout 기능을 활용해서 마우스가 옆에 있는 li태그로 이동을 하면 기존에 이벤트는 제거가 되고, 신규 이벤트가 이전에 설정했던 기능을 그대로 구현!!!
